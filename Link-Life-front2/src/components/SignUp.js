        ...
        >
          <div>
            ...
            <h2 className="text-3xl font-bold text-center">
              소중한 일생을 <span className="text-green-700">연결</span>하고자
              한다면, <br />
              가입하세요!
            </h2>
          </div>
          ...
          <form
            onSubmit={async (e) => {
              ...
              try {
                ...
                console.log(username, userphone, useremail, userid, userpw);
                console.log(data);
              } catch (error) {
                console.error(error);
              }
            }}
            className="py-12 px-11"
          >
            <fieldset
              style={{
            ...
            >
              ...
              <div className="px-16 py-4">
                ...
                <input
                  ...
                  className="px-3 py-2 w-80 focus:outline-green-800"
                  style={{
                    borderRadius: "10px",
                    border: "1px solid #757575",
                    width: "485px",
              ...
              <div className="px-16 py-4">
                ...
                <input
                  type="text"
                  placeholder="예)linklife@gmail.com"
                  className="px-3 py-2 w-80 focus:outline-green-800"
                  style={{
                    // border: 'none',
                    // borderBottom: '1px solid #757575',
              ...
              <div className="px-16 py-4">
                ...
                />
                <p className="py-1 text-sm font-thin">
                  *6~13자의 영문, 숫자, 특수문자의 조합으로 작성해주세요
                </p>
              </div>
            ...
            >
              <button
                className="text-green-800 bg-gray-100 hover:bg-gray-200"
                style={{
                  borderRadius: "10px",
                  // border: '1px solid #265136',
                  fontWeight: "bold",
