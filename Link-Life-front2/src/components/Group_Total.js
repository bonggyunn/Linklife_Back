...
const Group_Total = () => {
  ...
  const loggedInUser = dataCollection_groupMember.find(
  ...
  return (
      <>
        ...
        <div className="flex">
          ...
          <div
              className="fixed h-full pt-2 w-96"
              style={{
                ...
                <div>
                  <span className="relative inset-y-0 left-0 flex items-center p-1 mx-2 bg-gray-200 rounded-xl w-80">
                    <input
                        type="text"
                        placeholder="그룹 검색"
                        className="hidden w-full px-4 py-1 bg-gray-200 rounded outline-none md:block"
                    />
                    <button className="p-2 focus:outline-none md:text-gray-600">
                      <FaSearch/>
                    </button>
                  </span>
                </div>
                      ...
                      >
                        ...
                        >
                          ...
                          <div>
                            ...
                            >
                              {/* 일정 */}
                              <span className="p-2 text-sm text-gray-400">
                              {item.title}
                            </span>
                              <span className="p-2 text-sm text-gray-400">
                              {item.user}
            ...
            <nav className="flex justify-between px-4 py-3 bg-white border">
              <div className="relative">
                <button className="text-black group"
                  ...
                  <div
                      className="absolute z-10 hidden w-20 bg-gray-200 rounded-lg shadow -right-12 group-hover:block top-full">
              ...
              <div className="flex items-center text-xl">
                <span className="font-semibold">
                  {dataCollection_groupInfo[0].name}
                </span>
                <span className="ml-2 text-[#A6A6A6]">
                  {dataCollection_groupInfo[0].numberOfPeople}
                </span>
              </div>
              ...
              <div className="flex items-center m-1 gap-x-5">
                ...
                <div className="relative">
                  <button className="text-black group">
                    ...
                    <div
                        className="absolute z-10 hidden w-20 bg-gray-200 rounded-lg shadow -right-7 group-hover:block top-full">
                      <ul className="py-2 text-xs text-gray-950">
                        <li>친구</li>
                      </ul>
                    </div>
                ...
                <div className="relative">
                  <button className="text-black group">
                    <Link to="/group/calendar">
                      <div className="text-black">
                        <FaCalendarAlt className="w-6 h-6 mt-1"/>
                      </div>
                    </Link>
                    <div
                        className="absolute z-10 hidden w-20 bg-gray-200 rounded-lg shadow -right-7 group-hover:block top-full">
                ...
                <div className="relative">
                  <button className="text-black group">
                    ...
                    <div
                        className="absolute right-0 z-10 hidden w-20 bg-gray-200 rounded-lg shadow group-hover:block group-focus:block top-full">
                      <ul className="py-2 text-xs text-gray-950">
                        <li>
                          <a
                              href=""
                        ...
                        >
                          ...
                          >
                            <div className="flex w-full h-full">
                              {/* 타임라인 설계 영역(핵심 영역) */}
                              <div>
                                {item.name === username && <MainTimeLine posts={posts}/>}
                              </div>
                            </div>
                          </div>
                        </div>
