                ...
                <div>
                  ...
                  >
                    <span className="text-xl font-bold">
                      {dataCollection_my[0].name}
                    </span>
                    <span className="text-sm text-gray-400">
                      {dataCollection_my[0].date}
                    </span>
                  </div>
                  <div
            ...
            <div className="h-full f-container">
              <div className="f-accordion-faq">
                ...
                {dataCollection_tab1.map((item, index) => (
                  <div
                    key={index}
                    onClick={() => toggleBookmarkAccordion(index)}
                  >
                    <div className="f-accordion-faq-heading">
                      <h3
                        className={
                          bookmarkAccordion === index ? "f-active" : ""
                        }
                      >
                        {item.title_name}
                      </h3>
                ...
                {dataCollection_tab2.map((item, index) => (
                  <div key={index} onClick={() => toggleFriendAccordion(index)}>
                    <div className="f-accordion-faq-heading">
                      <h3
                        className={friendAccordion === index ? "f-active" : ""}
                      >
                        {item.title_name}
                      </h3>
                      <div>
                    ...
                    <div>
                      ...
                      <p
                        className={
                          friendAccordion === index ? "f-active" : "f-inactive"
                        }
                      >
                        {dataCollection_friend.map((item, index) => (
                          <div
                            key={index}
                            onClick={() => toggleFriendAccordion(index)}
                          >
                            {/* ******* 친구 리스트 (가로 한세트 start) ******** */}
                            <div
                              className="flex h-full"
